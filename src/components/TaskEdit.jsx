...
function TaskEdit({ onClose, orgId, projectId, sprintId, onTaskCreated, taskId }) {
    ...
    const onSubmit = (data) => {
        ...
        api.patch(`/api/v1/org/sprint/single/task/edit/org/${orgId}/sprint/${sprintId}/${taskId}`, submitData).then((response) => {
    ...
    useEffect(() => {
        api.get(`/api/v1/org/sprint/single/task/org/${orgId}/sprint/${sprintId}/${taskId}`).then((response) => {
            ...
            reset({
                ...
                startDate: response.data.task.startDate.split('T')[0],
    ...
    return (
        <div><section className="bg-transparent">
            <div className="px-0 mx-auto max-w-2xl">
                <h2 className="mb-4 text-xl font-bold ww-heading">Edit Task</h2>
